...
default_args = {
    'owner': 'airflow',           # DAG owner for monitoring and alerts
...
snowflake_create_table = SQLExecuteQueryOperator(
    ...
    conn_id="snowflake_conn_v2"                             # Snowflake connection ID from Airflow
)
...
snowflake_copy = SQLExecuteQueryOperator(
    ...
    sql="""COPY INTO news_api.PUBLIC.news_api_data 
            ...
            """,
    conn_id="snowflake_conn_v2"                             # Snowflake connection ID
)
